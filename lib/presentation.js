...
//  return +this.content["docProps/app.xml"]["Properties"]["Slides"][0];
  return Object.keys(this.content).filter(function(key) { return key.substr(0,16) === "ppt/slides/slide"}).length;
}

Presentation.prototype.getChartCount = function() {
  return Object.keys(this.content).filter(function(key) { return key.substr(0,16) === "ppt/charts/chart"}).length;
}
