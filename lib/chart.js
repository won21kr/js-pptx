...
Chart.prototype.load = function (chartInfo, done) {
  ...
  var defaults = presentation.content["[Content_Types].xml"]["Types"]["Default"].filter(function (el) {
